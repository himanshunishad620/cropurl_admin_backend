...
const getRegistrationLinkUi = (verificationLink) => `<html lang="en">
<head>
<meta charset="UTF-8">
...
const getForgotPasswordLinkUi = (verificationLink) => `<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div style="display:none; max-height:0; overflow:hidden; opacity:0;">
  Reset your CropURL password. This link expires in 15 minutes.
</div>
      ...
      <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="width:480px; max-width:100%; background-color:#FFFFFF; border-radius:16px; border:1px solid #E2E8F0; overflow:hidden;">
        ...
        <tr>
          <td style="padding:20px 40px 0 40px;">
            ...
            <p style="margin:0; font-size:15px; line-height:1.6; color:#475569; font-family:Helvetica, Arial, sans-serif;">
              We received a request to reset the password for your CropURL account. Click the button below to choose a new one.
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:20px 40px 0 40px;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FAEEDA; border-radius:8px;">
              <tr>
                <td style="padding:12px 16px; font-size:13px; line-height:1.5; color:#633806; font-family:Helvetica, Arial, sans-serif;">
                  This link expires in 15 minutes. After that, you'll need to request a new one.
                </td>
              </tr>
            </table>
          </td>
...
const getUpdateEmailLinkUi = (verficationLink) => `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
      ...
      <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="width:480px; max-width:100%; background-color:#FFFFFF; border-radius:16px; border:1px solid #E2E8F0; overflow:hidden;">
        ...
        <tr>
          <td style="padding:20px 40px 0 40px;">
            ...
            <p style="margin:0; font-size:15px; line-height:1.6; color:#475569; font-family:Helvetica, Arial, sans-serif;">
              You requested to change the email address on your CropURL account. Click the button below to verify this new email and complete the update.
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:20px 40px 0 40px;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FAEEDA; border-radius:8px;">
              <tr>
                <td style="padding:12px 16px; font-size:13px; line-height:1.5; color:#633806; font-family:Helvetica, Arial, sans-serif;">
                  ⚠️ This link expires in 15 minutes. If it expires, you'll need to request a new email change.
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td style="padding:20px 40px 0 40px;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#F0FDF4; border-radius:8px; border-left:4px solid #22C55E;">
              <tr>
                <td style="padding:12px 16px; font-size:13px; line-height:1.5; color:#166534; font-family:Helvetica, Arial, sans-serif;">
                  🔒 This request was made from your account. If you didn't request this change, <strong>contact support immediately</strong>.
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td style="padding:20px 40px 36px 40px;">
            <p style="margin:0; font-size:12px; line-height:1.6; color:#94A3B8; font-family:Helvetica, Arial, sans-serif;">
              If you didn't request this email change, your account remains safe. No changes have been made yet.
            </p>
          </td>
        </tr>
